...
export class Migration1761774309849 implements MigrationInterface {
    name = 'Migration1761774309849'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`used_discounts\` ADD \`status\` enum ('PENDING', 'USED') NOT NULL DEFAULT 'PENDING'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` DROP COLUMN \`status\``);
    }
