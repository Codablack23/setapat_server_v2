...
export class Migration1760862065041 implements MigrationInterface {
    name = 'Migration1760862065041'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` ADD \`page_type\` enum ('PAGE', 'RESIZE') NOT NULL DEFAULT 'PAGE'`);
        ...
        await queryRunner.query(`ALTER TABLE \`messages\` CHANGE \`revisions\` \`revisions\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`messages\` CHANGE \`revisions\` \`revisions\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` DROP COLUMN \`page_type\``);
    }
