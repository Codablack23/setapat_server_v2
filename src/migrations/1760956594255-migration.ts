...
export class Migration1760956594255 implements MigrationInterface {
    name = 'Migration1760956594255'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_resize_extras\` ADD \`price\` int NOT NULL DEFAULT '100000'`);
