...
export class Migration1761748293305 implements MigrationInterface {
    name = 'Migration1761748293305'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_edits\` CHANGE \`delivery_date\` \`delivery_date\` datetime NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_edits\` CHANGE \`delivery_date\` \`delivery_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`order_edits\` ADD CONSTRAINT \`FK_7c271f3f06495649cd7404ee2a7\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
