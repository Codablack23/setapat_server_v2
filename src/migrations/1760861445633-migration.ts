...
export class Migration1760861445633 implements MigrationInterface {
    name = 'Migration1760861445633'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`revisions_per_page\` (\`id\` varchar(36) NOT NULL, \`type\` enum ('ORDER', 'EDIT') NOT NULL DEFAULT 'ORDER', \`page\` int NOT NULL, \`resize_page\` int NULL, \`orderId\` varchar(36) NULL, \`orderEditId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`order_submissions\` DROP COLUMN \`revisions\``);
        await queryRunner.query(`ALTER TABLE \`messages\` ADD \`revisions\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_submissions\` ADD \`revisions\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`DROP TABLE \`revisions_per_page\``);
    }
