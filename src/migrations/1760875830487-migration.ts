...
export class Migration1760875830487 implements MigrationInterface {
    name = 'Migration1760875830487'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`message_revisions\` (\`id\` varchar(36) NOT NULL, \`revisions\` int NOT NULL, \`page_type\` enum ('PAGE', 'RESIZE') NOT NULL DEFAULT 'PAGE', \`page\` int NOT NULL, \`resize_page\` int NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`messageId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`messages\` DROP COLUMN \`revisions\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`messages\` ADD \`revisions\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`DROP TABLE \`message_revisions\``);
    }
