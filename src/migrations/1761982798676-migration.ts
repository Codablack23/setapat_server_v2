...
export class Migration1761982798676 implements MigrationInterface {
    name = 'Migration1761982798676'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`discounts\` ADD \`allowed_user_email\` json NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`message_revisions\` DROP FOREIGN KEY \`FK_e5024b900eddd0cbbb843494d51\``);
        await queryRunner.query(`ALTER TABLE \`message_revisions\` CHANGE \`resize_page\` \`resize_page\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`message_revisions\` CHANGE \`messageId\` \`messageId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` DROP FOREIGN KEY \`FK_cd85639573ddefc95819c8a20cc\``);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` DROP FOREIGN KEY \`FK_8749c47ab04418e213ac14d10fb\``);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` CHANGE \`resize_page\` \`resize_page\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` CHANGE \`orderId\` \`orderId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` CHANGE \`orderEditId\` \`orderEditId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`max_use\` \`max_use\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`min_order_amount\` \`min_order_amount\` decimal(10,2) NULL`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`max_discount_amount\` \`max_discount_amount\` decimal(10,2) NULL`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`starts_at\` \`starts_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`expires_at\` \`expires_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`active_time\` \`active_time\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`discounts\` DROP COLUMN \`active_days\``);
        await queryRunner.query(`ALTER TABLE \`discounts\` ADD \`active_days\` json NULL`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` DROP FOREIGN KEY \`FK_d0efb9e2198113dac1efe2e5976\``);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` DROP FOREIGN KEY \`FK_8e7054f2082371dd1e011e94784\``);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` CHANGE \`discountId\` \`discountId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` CHANGE \`userId\` \`userId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`delivery_date\` \`delivery_date\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`started_at\` \`started_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`commenced_at\` \`commenced_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`completed_at\` \`completed_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`last_edited_at\` \`last_edited_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`userId\` \`userId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`discountId\` \`discountId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`message_revisions\` ADD CONSTRAINT \`FK_e5024b900eddd0cbbb843494d51\` FOREIGN KEY (\`messageId\`) REFERENCES \`messages\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` ADD CONSTRAINT \`FK_cd85639573ddefc95819c8a20cc\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` ADD CONSTRAINT \`FK_8749c47ab04418e213ac14d10fb\` FOREIGN KEY (\`orderEditId\`) REFERENCES \`order_edits\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_resize_extras\` ADD CONSTRAINT \`FK_81c1107339f14b4fd8d807c08d6\` FOREIGN KEY (\`editPageId\`) REFERENCES \`order_edit_pages\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_resize_extras\` ADD CONSTRAINT \`FK_5f8431bc8f8d48bfdf9045adcfd\` FOREIGN KEY (\`orderPageId\`) REFERENCES \`order_pages\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_brief_attachments\` ADD CONSTRAINT \`FK_4e5dc810a0b73080f5786e9ce4d\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`used_discounts\` ADD CONSTRAINT \`FK_d0efb9e2198113dac1efe2e5976\` FOREIGN KEY (\`discountId\`) REFERENCES \`discounts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` ADD CONSTRAINT \`FK_8e7054f2082371dd1e011e94784\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_151b79a83ba240b0cb31b2302d1\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_b7e1358a054f59f61e40b70ba8f\` FOREIGN KEY (\`discountId\`) REFERENCES \`used_discounts\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`discountId\` \`discountId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`userId\` \`userId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`last_edited_at\` \`last_edited_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`completed_at\` \`completed_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`commenced_at\` \`commenced_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`started_at\` \`started_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`delivery_date\` \`delivery_date\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`design_samples\``);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_b7e1358a054f59f61e40b70ba8f\` FOREIGN KEY (\`discountId\`) REFERENCES \`used_discounts\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_151b79a83ba240b0cb31b2302d1\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` CHANGE \`userId\` \`userId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` CHANGE \`discountId\` \`discountId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` ADD CONSTRAINT \`FK_8e7054f2082371dd1e011e94784\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`used_discounts\` ADD CONSTRAINT \`FK_d0efb9e2198113dac1efe2e5976\` FOREIGN KEY (\`discountId\`) REFERENCES \`discounts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`discounts\` DROP COLUMN \`active_days\``);
        await queryRunner.query(`ALTER TABLE \`discounts\` ADD \`active_days\` longtext CHARACTER SET "utf8mb4" COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`active_time\` \`active_time\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`expires_at\` \`expires_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`starts_at\` \`starts_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`max_discount_amount\` \`max_discount_amount\` decimal(10,2) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`min_order_amount\` \`min_order_amount\` decimal(10,2) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`discounts\` CHANGE \`max_use\` \`max_use\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_edits\` ADD CONSTRAINT \`FK_7c271f3f06495649cd7404ee2a7\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` CHANGE \`orderEditId\` \`orderEditId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` CHANGE \`orderId\` \`orderId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` CHANGE \`resize_page\` \`resize_page\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` ADD CONSTRAINT \`FK_8749c47ab04418e213ac14d10fb\` FOREIGN KEY (\`orderEditId\`) REFERENCES \`order_edits\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`revisions_per_page\` ADD CONSTRAINT \`FK_cd85639573ddefc95819c8a20cc\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`messages\` ADD CONSTRAINT \`FK_2db9cf2b3ca111742793f6c37ce\` FOREIGN KEY (\`senderId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`messages\` ADD CONSTRAINT \`FK_e5663ce0c730b2de83445e2fd19\` FOREIGN KEY (\`conversationId\`) REFERENCES \`conversations\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`message_revisions\` CHANGE \`messageId\` \`messageId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message_revisions\` CHANGE \`resize_page\` \`resize_page\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message_revisions\` ADD CONSTRAINT \`FK_e5024b900eddd0cbbb843494d51\` FOREIGN KEY (\`messageId\`) REFERENCES \`messages\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`discounts\` DROP COLUMN \`allowed_user_email\``);
    }
