...
export class Migration1760173351117 implements MigrationInterface {
    name = 'Migration1760173351117'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_pages\` DROP COLUMN \`page_number\``);
        await queryRunner.query(`ALTER TABLE \`order_pages\` ADD \`page_number\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_pages\` CHANGE \`price\` \`price\` bigint NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_pages\` CHANGE \`price\` \`price\` bigint NOT NULL DEFAULT '500000'`);
        await queryRunner.query(`ALTER TABLE \`order_pages\` DROP COLUMN \`page_number\``);
        await queryRunner.query(`ALTER TABLE \`order_pages\` ADD \`page_number\` bigint NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_pages\` ADD CONSTRAINT \`FK_a84c556870d8dac48c3a725bec3\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
