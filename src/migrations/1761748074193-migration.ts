...
export class Migration1761748074193 implements MigrationInterface {
    name = 'Migration1761748074193'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`order_edits\` ADD \`delivery_time\` int NOT NULL DEFAULT '4'`);
        await queryRunner.query(`ALTER TABLE \`order_edits\` ADD \`amount\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_edits\` ADD \`delivery_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_edits\` DROP COLUMN \`delivery_date\``);
        await queryRunner.query(`ALTER TABLE \`order_edits\` DROP COLUMN \`amount\``);
        await queryRunner.query(`ALTER TABLE \`order_edits\` DROP COLUMN \`delivery_time\``);
    }
