...
exports.Migration1758625966391 = void 0;
class Migration1758625966391 {
    name = 'Migration1758625966391';
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`gender\` enum ('USER', 'DESIGNER', 'BILLERS', 'ADMIN') NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`reason\` longtext NULL`);
...
exports.Migration1758625966391 = Migration1758625966391;
//# sourceMappingURL=1758625966391-migration.js.map