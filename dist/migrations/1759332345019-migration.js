...
exports.Migration1759332345019 = void 0;
class Migration1759332345019 {
    name = 'Migration1759332345019';
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`messages\` CHANGE \`type\` \`type\` enum ('TEXT', 'ATTACHMENT', 'VOICE_NOTE', 'SUBMISSION') NOT NULL DEFAULT 'TEXT'`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`messages\` CHANGE \`type\` \`type\` enum ('TEXT', 'ATTACHMENT', 'VOICE_NOTE') NOT NULL DEFAULT ''TEXT''`);
...
exports.Migration1759332345019 = Migration1759332345019;
//# sourceMappingURL=1759332345019-migration.js.map