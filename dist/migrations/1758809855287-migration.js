...
exports.Migration1758809855287 = void 0;
class Migration1758809855287 {
    name = 'Migration1758809855287';
    async up(queryRunner) {
        await queryRunner.query(`DROP INDEX \`IDX_147517de3d2ffce1a3daffcf6b\` ON \`designer_profiles\``);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`order_resize_extras\` ADD CONSTRAINT \`FK_d5548982ea4b9918af86b32496e\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_147517de3d2ffce1a3daffcf6b\` ON \`designer_profiles\` (\`userId\`)`);
    }
}
exports.Migration1758809855287 = Migration1758809855287;
//# sourceMappingURL=1758809855287-migration.js.map