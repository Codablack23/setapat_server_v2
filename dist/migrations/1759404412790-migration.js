...
exports.Migration1759404412790 = void 0;
class Migration1759404412790 {
    name = 'Migration1759404412790';
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`discounts\` ADD \`is_active\` tinyint NOT NULL DEFAULT 1`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`discounts\` DROP COLUMN \`is_active\``);
    }
}
exports.Migration1759404412790 = Migration1759404412790;
//# sourceMappingURL=1759404412790-migration.js.map