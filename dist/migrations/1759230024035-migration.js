...
exports.Migration1759230024035 = void 0;
class Migration1759230024035 {
    name = 'Migration1759230024035';
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`started_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`started_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`commenced_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`commenced_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`completed_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`completed_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`last_edited_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`last_edited_at\` timestamp NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`last_edited_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`last_edited_at\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`completed_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`completed_at\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`commenced_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`commenced_at\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`started_at\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`started_at\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`delivery_date\``);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`delivery_date\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`design_samples\``);
...
exports.Migration1759230024035 = Migration1759230024035;
//# sourceMappingURL=1759230024035-migration.js.map