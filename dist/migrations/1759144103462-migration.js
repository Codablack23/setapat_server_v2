...
exports.Migration1759144103462 = void 0;
class Migration1759144103462 {
    name = 'Migration1759144103462';
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`order_resize_extras\` DROP COLUMN \`amount\``);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_resize_extras\` ADD \`amount\` bigint NOT NULL`);
    }
}
exports.Migration1759144103462 = Migration1759144103462;
//# sourceMappingURL=1759144103462-migration.js.map