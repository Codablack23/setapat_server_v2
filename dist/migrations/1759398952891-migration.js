...
exports.Migration1759398952891 = void 0;
class Migration1759398952891 {
    name = 'Migration1759398952891';
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`discounts\` (\`id\` varchar(36) NOT NULL, \`type\` enum ('PERCENTAGE', 'FLAT') NOT NULL DEFAULT 'PERCENTAGE', \`code\` varchar(20) NOT NULL, \`description\` longtext NOT NULL, \`duration_hours\` int NOT NULL, \`is_one_time\` tinyint NOT NULL DEFAULT 0, \`max_use\` int NULL, \`amount\` decimal(10,2) NOT NULL DEFAULT '30.00', \`min_order_amount\` decimal(10,2) NULL, \`max_discount_amount\` decimal(10,2) NULL, \`starts_at\` timestamp NULL, \`expires_at\` timestamp NULL, \`active_time\` time NULL, \`active_days\` json NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_8c7cc2340e9ea0fc5a246e6374\` (\`code\`), INDEX \`IDX_424b686b67889fb418549c5770\` (\`starts_at\`), INDEX \`IDX_a482a0764a940e49254bb29ad4\` (\`expires_at\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`used_discounts\` (\`id\` varchar(36) NOT NULL, \`amount\` int NOT NULL DEFAULT '3000', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`discountId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`discountId\` varchar(36) NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`discountId\``);
        await queryRunner.query(`DROP TABLE \`used_discounts\``);
        await queryRunner.query(`DROP INDEX \`IDX_a482a0764a940e49254bb29ad4\` ON \`discounts\``);
        await queryRunner.query(`DROP INDEX \`IDX_424b686b67889fb418549c5770\` ON \`discounts\``);
        await queryRunner.query(`DROP INDEX \`IDX_8c7cc2340e9ea0fc5a246e6374\` ON \`discounts\``);
        await queryRunner.query(`DROP TABLE \`discounts\``);
    }
}
exports.Migration1759398952891 = Migration1759398952891;
//# sourceMappingURL=1759398952891-migration.js.map