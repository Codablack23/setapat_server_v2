...
exports.Migration1759233597231 = void 0;
class Migration1759233597231 {
    name = 'Migration1759233597231';
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`delivery_time\` int NOT NULL DEFAULT '24'`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`order_receipt\` ADD CONSTRAINT \`FK_6bcc142e76d004e355d733c99a0\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`delivery_time\``);
    }
}
exports.Migration1759233597231 = Migration1759233597231;
//# sourceMappingURL=1759233597231-migration.js.map